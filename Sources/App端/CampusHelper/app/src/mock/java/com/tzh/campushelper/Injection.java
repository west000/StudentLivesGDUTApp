...
import com.tzh.campushelper.content.FakeSharedPreference;
import com.tzh.campushelper.service.ApiService;
import com.tzh.campushelper.service.DummyApiService;
...
public class Injection {
    ...
    public static ApiService provideApiService(Context context) {
        return DummyApiService.getInstance();
    }

    public static CookieJar provideCookieJar(Context context) {
        return new PersistentCookieJar(new SetCookieCache(), new SharedPrefsCookiePersistor(new FakeSharedPreference()));
    }
